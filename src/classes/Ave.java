...
public class Ave extends Pets{
    ...
    public Ave(int idPets, String nome, String tipo, String genero, String status, String porte, String localP, String localA, java.sql.Date dataA, java.sql.Date dataP ,String especie, String penugem, int registroIbama) {
